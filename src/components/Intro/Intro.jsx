    ...
    <div className="Intro" id="Intro">
      ...
      <div className="i-left">
        <div className="i-name">
          ...
          <span>Keval Vasoya</span>
          <span>
            Web Developers Bulid And Mantain Website And Web Application Using Programing.
            Desing Tools And Languages Such as HTML,Css,Javascript. 
          </span>
        </div>
